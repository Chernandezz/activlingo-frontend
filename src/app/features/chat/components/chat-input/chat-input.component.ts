  ...
  template: `
    <div class="mt-2 flex items-center gap-2">
      <input
        ...
        class="flex-grow p-3 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
      />

      <button
        (click)="toggleVoiceMode()"
        class="p-3 rounded-full bg-gray-600 hover:bg-gray-500 transition-colors"
        [class.bg-red-600]="isVoiceMode"
        [class.hover:bg-red-700]="isVoiceMode"
      >
        <svg
